...
class MemeManager(models.Manager):
    def create_meme(self, meme_data, meme_picture):
        meme = self.create()
        meme.meme_source_name = meme_data['post_id']
        meme.meme_source_topic = 57846937
        meme.meme_date = meme_data['date']
        meme.meme_pic_size = meme_data['size']
...
class Meme(models.Model):
    ...
    meme_pic_size = models.PositiveIntegerField()
    meme_date = models.PositiveIntegerField()
