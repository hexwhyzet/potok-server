...
# from potok_app.models import Picture, Profile, Session, PictureLike, PictureData, PictureReport
...
#     pictures = list(
#         map(lambda x: x.picture,
#             PictureLike.objects.filter(profile=profile_id).order_by('-date')[offset:offset + number]))
#     return pictures
#
#
