...
# from potok_app.models import Profile, Avatar, ProfileBlock
...
#
#
# def is_profile_content_available(user_profile: Profile, profile: Profile):
#     if is_profile_users(user_profile, profile):
#         return True
#
...
#         return True
#
#     return is_profile_content_available(user_profile, profile) and profile.are_liked_pictures_public
#
#
...
#         url = upload_picture_bytes(resized_picture, f'{config["image_server_directory"]}/{id_gen(50)}.{extension}')
