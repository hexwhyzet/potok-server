...
from potok_users.backends import RegistrationSerializer, LoginSerializer, AnonymousLoginSerializer, \
    AnonymousRegistrationSerializer, InitiateVerificationSerializer, ValidateCredentialsSerializer
...
class ValidateCredentialsAPIView(APIView):
    """
    Registers a new user.
    """
    permission_classes = [AllowAny]
    serializer_class = ValidateCredentialsSerializer
...
class InitiateVerification(APIView):
    """
    Logs in an existing user.
    """
    permission_classes = [AllowAny]
    serializer_class = InitiateVerificationSerializer
